...
export function validateState() {
    ...
    if (!settings.global) {
        ...
        settings.global = {
            ...
            injectDashboard: DEFAULT_STATE.injectDashboard !== undefined ? DEFAULT_STATE.injectDashboard : DEFAULT_STATE.injectDashboard,
            dashboardStyle: DEFAULT_STATE.dashboardStyle || 'modern',
